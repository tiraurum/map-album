...
const THEMES = {
  ...
  gold: {
    ...
    // Map geo styles
    geoBorder: '#FCC065',
    geoBorderVisited: '#FCC065',
    geoFillVisited: '#FCC065',
    geoFillParent: '#FCC065',
    geoHoverFill: '#fdda94',
    geoHoverBorder: '#fdda94',
    // Status colors
    wannaGoBorder: '#60a5fa',
    wannaGoFill: '#3b82f6',
    plannedBorder: '#34d399',
  ...
  orange: {
    ...
    // Map geo styles
    geoBorder: '#FFA43A',
    geoBorderVisited: '#FFA43A',
    geoFillVisited: '#FFA43A',
    geoFillParent: '#FFA43A',
    geoHoverFill: '#ffbe70',
    geoHoverBorder: '#ffbe70',
    // Status colors
    wannaGoBorder: '#60a5fa',
    wannaGoFill: '#3b82f6',
    plannedBorder: '#34d399',
